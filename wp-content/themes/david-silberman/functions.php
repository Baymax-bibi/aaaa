...
function blogStageSel()
{
   if( is_home()== 'true') return true;

   else if( is_single()== 'true') return true;

   else if( is_category() == 'true') return true;

   else if( is_archive() == 'true') return true;
...
function custom_login_logo() {
	...
	<style>
	body.login {
		background: url(".get_bloginfo('template_url')."/images/admin-bg.jpg) no-repeat center top;
		min-width:0;
	}
	
	body.login #login h1 a {
	
		background:url(".get_bloginfo('template_url')."/images/logo-login.png) no-repeat top center;
		width:310px;
		height:40px;
		text-indent:-9999px;
		overflow:hidden;
	...
	.login form {
		...
		font-weight:normal;
		background: url(".get_bloginfo('template_url')."/images/field-back.jpg) repeat-x center top;
...
/* Hide wordpress updation message from admin side */
